package com.github.autotest.sapient.ift.testcase.autocreate;

import java.util.List;

import com.github.autotest.sapient.dispatch.testcase.CreateXmlFile;
import com.github.autotest.sapient.dispatch.testcase.SuperCase;
import com.github.autotest.sapient.ift.IftConf;
import com.github.autotest.sapient.ift.testcase.format.FormatCase;
import com.github.autotest.sapient.toolkit.util.CompilerUtil;
import com.github.autotest.sapient.toolkit.util.FileUtil;
...
public class IftDataFileCase extends SuperCase{
	...
	public IftDataFileCase() {
		super();
		String threadEnable = IftConf.threadEnable;
		String parallel = IftConf.Parallel;
		int threadCont = IftConf.ThreadCont;
		createJavaFile = new CreateJavaFile();
		if(threadEnable.equalsIgnoreCase("Y")&parallel.equals("methods")||parallel.equals("tests")||parallel.equals("classes")){	
			createXmlFile = new CreateXmlFile(threadCont,parallel);
